...
def extract_features_all():
    ...
    non_car1=glob.glob('/home/sakthi/Nithin/seventhtuesday/non-vehicles/GTI/*.png')
    car1=glob.glob('/home/sakthi/Nithin/seventhtuesday/vehicles/KITTI_extracted/*.png')
    for i in range(0,len(non_car1)):
        non_car=cv2.imread(non_car1[i])
    for i in range(0,len(car1)):
        car=cv2.imread(car1[i])	
    #print(np.matrix(car))	
